...
class ProductRepositoryImpl extends ProductRepository {
  ...
  Future<String> createSample(SampleProductModel smaple) async {
    Response response;
    try {
      response = await http$.post(ProductApis.sampleCreate,
          data: SampleProductModel.toJson(smaple));
    } on DioError catch (e) {
      print(e);
    }
    if (response != null && response.statusCode == 200) {
  ...
  Future<String> updateSample(SampleProductModel smaple) async {
    Response response;
    try {
      response = await http$.put(ProductApis.sampleUpdate,
          data: SampleProductModel.toJson(smaple));
    } on DioError catch (e) {
      print(e);
    }
  ...
  Future<SampleProductHistorysResponse> sampleHistorys(
    ...
    Response response;
    try {
      response = await http$.post(ProductApis.sampleHistorys,
          data: data, queryParameters: params);
    } on DioError catch (e) {
      print(e);
    }
  ...
  @override
  Future<String> createSampleHistory(
      SampleBorrowReturnHistoryModel sample) async {
    Response response;
    try {
      response = await http$.post(ProductApis.sampleHistoryCreate,
          data: SampleBorrowReturnHistoryModel.toJson(sample));
    } on DioError catch (e) {
      print(e);
    }
    if (response != null && response.statusCode == 200) {
  ...
  @override
  Future<String> updateSampleHistory(
      SampleBorrowReturnHistoryModel sample) async {
    Response response;
    try {
      response = await http$.put(ProductApis.sampleHistoryUpdate(sample.id),
          data: SampleBorrowReturnHistoryModel.toJson(sample));
    } on DioError catch (e) {
      print(e);
    }
