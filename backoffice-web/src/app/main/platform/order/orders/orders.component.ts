...
export class OrdersComponent implements OnInit, OnDestroy {
    ...
    displayedColumns = ['reference', 'customer', 'total', 'payment', 'status', 'date'];
     ...
     * Constructor
     *
     * @param {OrdersService} _ecommerceOrdersService
     */
    constructor(
        private _ecommerceOrdersService: OrdersService
    ) {
