class GlobalConfigs {
  ...
  //本地
  // static const CONTEXT_PATH = 'https://192.168.1.92:9002/djwebservices/v2';
  // static const MEDIA_CONTEXT_PATH = 'http://192.168.1.92';
  ...
  //     'https://192.168.1.92:9002/authorizationserver';
