class GlobalConfigs {
  ...
  //本地
  // static const CONTEXT_PATH = 'https://192.168.1.177:9002/djwebservices/v2';
  // static const MEDIA_CONTEXT_PATH = 'http://192.168.1.177';
  ...
  //     'https://192.168.1.177:9002/authorizationserver';
  ...
  ///款式搜索
  static const PRODUCTS_HISTORY_KEYWORD_KEY = 'products_history_keyword_key';
  ...
  ///微信小程序原始ID
  static const MINI_PROGRAM_ID = "gh_07d47c9fd2dd";

  ///Apple 授权clientId
  static const APPLE_CLIENT_ID = "com.nbyjy.b2bcommerce";
}
