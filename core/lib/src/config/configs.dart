class GlobalConfigs {
  ...
  //本地
  static const CONTEXT_PATH = 'https://192.168.31.179:9002/djwebservices/v2';
  static const MEDIA_CONTEXT_PATH = 'http://192.168.31.179';
  ...
  static const AUTH_SERVER_URL =
      'https://192.168.31.179:9002/authorizationserver';
