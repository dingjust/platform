class GlobalConfigs {
  ...
  static const CONTEXT_PATH = 'https://192.168.1.114:9002/djwebservices/v2';
  static const MEDIA_CONTEXT_PATH =
      'https://192.168.1.114:9002/djwebservices/v2';
  ...
  static get WEBSOCKET_URL =>
        ...
        //  return 'ws://192.168.1.114:8088/message?token=$token&userId=$uid';
  ...
  static const AUTH_SERVER_URL =
      'https://192.168.1.114:9002/authorizationserver';
