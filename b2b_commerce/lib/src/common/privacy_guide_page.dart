                            ...
                            child: Scrollbar(
                              child: ListView(
                                ...
                                children: [
                                  ...
                                  _buildTitle2(),
                                  _Text(
                                      '1. 在您使用APP时，为帮助我们更加了解您如何接入和使用我们的产品或服务、维护我们的产品与/或服务、维护钉单APP最基本的业务运转或对您做出其他方面的回应。为实现向您展现或推荐相关程度更高（而非普遍推送的内容或者广告）,在你浏览、评价、发布内容是，我们可能会收集、使用你的设备信息（包括设备型号、唯一设备标识符如IMEI/IMSI信息、设备MAC地址、IP地址、软件安装列表、软件版本号等）、日志信息等;'),
                                  _Text(
                                      '2.根据你在使用钉单过程中的不同服务或场景，可能需要你开通一些设备权限，包括位置权限(匹配位置信息推荐符合您要求的工厂、需求信息)。存储、相册、相机权限，用于发布需求内容或产品内容时访问您的设备相机、相册、存储，并收集您提供的基于拍摄照片、拍摄视频后向我们上传的图片、视频信息;'),
                                  _Text(
                                      '3.定向推荐、维护/改进我们的产品与/或服务之必需（1） 我们会基于收集的信息，对您的偏好、习惯、位置作特征分析和用户画像，以便为您提供更适合的定制化服务，例如向您展现或推荐相关程度更高（而非普遍推送）的搜索结果、内容、信息流或者广告/推广信息结果。为此，我们需要收集（包括在后台状态下收集）您的信息，包括您的设备信息（例如硬件型号、设备MAC地址、IMEI、IDFA、IMSI、必要的软件列表）'),
                                  _Text(
                                      '4. 上述权限均不会默认或强制开启，你有权拒绝且你的拒绝不会影响钉单提供的基本功能服务;'),
                                  _Text(
                                      '5. 我们会努力采取各种安全技术保护你的个人信息，未经你同意，我们不会从第三方获取、共享或对外提供你的信息；'),
                                  // _Text(
                                  ...
                                  _Text(
                                      '8.我们的产品支持您使用第三方平台的账号（微信账号/钉钉账号）进行登录，如您使用第三方平台的账号登录的，我们将根据您的授权获取该第三方账号下的相关信息（包括：用户名、昵称、头像等）以及身份验证信息（个人敏感信息）。我们承诺，收集上述信息是用于为您提供账号登录服务以及保障您的账号安全，防范安全风险。如您拒绝授权此类信息，则您将无法使用第三方平台的账号登录我们平台，但不影响我们提供的其他产品和服务的正常使用。'),
                                  _Text(
                                      '9.同时，您需理解，手机号码或电子邮箱地址和验证码匹配结果属于您的个人敏感信息，我们收集该类信息是基于法律法规的相关要求，如您拒绝提供可能导致您无法注册账号并使用相关产品功能，请您谨慎考虑后再选择是否提供。'),
                                  _Text(
                                      '10.我们使用安全的技术、隐私保护的管理手段，和限制雇员接触隐私资料，以保护您的个人隐私。只有被授权的工作人员才能接触到您的个人资料，并且为数很少。'),
                                  _Text(
                                      '11.我们尊重你的选择权，你可以访问、更正、删除你的个人信息并管理你的授权，我们也为你提供注销、联系我们的渠道'),
                                  _Text(
