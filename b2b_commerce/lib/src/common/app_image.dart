...
Image getImage(String url, {String package = _package, double width = _width, double height = _height}) {
...
class MenuItemImage {
  ...
  static Image requirementOrder = getImage('temp/business/requirement_order.png');
  ...
  static Image registerCustomer = getImage('temp/business/register_customer.png');
  static Image registerFactory = getImage('temp/business/register_factory.png');
  static Image partnerFactory = getImage('temp/business/partner_manage_factory.png');
  static Image productFactory = getImage('temp/business/product_manage_factory.png');
  static Image productionFactory = getImage('temp/business/production_order_factory.png');
  static Image quoteFactory = getImage('temp/business/quote_manage_factory.png');
}
...
class B2BImage {
  ...
  static Image fastFactory({double width, double height}) {
    return getImage('temp/common/fast_factory.png', width: width, height: height);
  }

  static Image findFactory({double width, double height}) {
    return getImage('temp/common/find_factory.png', width: width, height: height);
  }

  static Image idleCapacity({double width, double height}) {
    return getImage('temp/common/idle_capacity.png', width: width, height: height);
  }
  ...
  static Image addressUnderLine({double width, double height}) {
    return getImage('temp/common/address_under_line.png', width: width, height: height);
  }
  ...
  static Image customerService({double width, double height}) {
    return getImage('temp/my/customer_service.png', width: width, height: height);
  }
  ...
  static Image companyIntroduce({double width, double height}) {
    return getImage('temp/my/company_introduce.png', width: width, height: height);
  }
}
