...
/// 产品搜索页
class EmployeeSearchDelegatePage extends SearchDelegate<B2BCustomerModel> {
  List<String> history_keywords;
  bool isSelectOption;

  EmployeeSearchDelegatePage({
    this.isSelectOption,
  }){
    getHistory();
  }
  ...
  void showResults(BuildContext context) {
    ...
    Navigator.pop(context,B2BCustomerModel(name: query));
  }
          ...
          child: Wrap(
              ...
              children: history_keywords
                  .map((keyword) => HistoryTag(
                        value: keyword,
                        onTap: () {
                          Navigator.pop(context,B2BCustomerModel(name: keyword));
                        },
                      ))
                  .toList()),
        )
