...
//      padding: EdgeInsets.all(10),
      ...
      child: Column(
        children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Stars(
                                starLevel: widget.order.belongTo.starLevel ?? 1,
                                highlightOnly: false,
                              ),
                              Icon(
                                Icons.chevron_right,
                  ...
                  children: <Widget>[
                    Container(
                      child: Row(
                        children: <Widget>[
                          Text('历史接单'),
                          Text(
                            widget.order.belongTo.historyOrdersCount.toString(),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            '${widget.order.belongTo.contactAddress?.city?.name} ${widget.order.belongTo.contactAddress?.cityDistrict?.name}',
          ...
          ListTile(
            title: Text('加工类型'),
            trailing: order.machiningType == null
                ? Container()
          ...
          ListTile(
            title: Text('是否开具发票'),
            trailing: order.invoiceNeeded == null
                ? Container()
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: order.purchaser == null ||
                            ...
                            : NetworkImage(
                                '${GlobalConfigs.IMAGE_BASIC_URL}${order.purchaser.profilePicture}'),
                        fit: BoxFit.cover,
                      )),
                ),
                Text(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: productionProgress.medias == null ||
                            ...
                            : NetworkImage(
                                '${GlobalConfigs.IMAGE_BASIC_URL}${productionProgress.medias[0].url}'),
                        fit: BoxFit.fill,
                      )),
                ),
                onTap: () {
                  Navigator.of(context)
                      .push(MaterialPageRoute(
                          builder: (context) => PicturePickPreviewWidget(
                                ...
                                isUpload:
                                    isCurrentStatus == true ? true : false,
                              )))
                      .then((value) {
                    if (value != null) {
                                ...
                                onPressed: () async {
                                  ...
                                  if (order.quoteRef != null) {
                                    QuoteModel detailModel =
                                        await QuoteOrderRepository()
                                            .getquoteDetail(order.quoteRef);
                                    if (detailModel != null) {
                                          ...
                                          child: ListBody(
                                            children: <Widget>[
                                              GestureDetector(
                                                child: ListTile(
                                                  title: Text(
                                                    '${order.deliveryAddress.fullname == null ? '' : order.deliveryAddress.fullname}  '
                                                        '${order.deliveryAddress.cellphone == null ? '' : order.deliveryAddress.cellphone}',
                                                  ),
                                                  subtitle: Text(
                                                    '${order.deliveryAddress == null ? '' : order.deliveryAddress.region.name} ${order.deliveryAddress.city.name} '
