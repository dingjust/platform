...
///外接订单块
class OutOrderItem extends StatelessWidget {
  final SalesProductionOrderModel model;

  const OutOrderItem(this.model, {Key key}) : super(key: key);
...
class _Header extends StatelessWidget {
  ...
  Widget _buildTag() {
    ...
    return model.managementMode == ManagementMode.AUTOGESTION
        ? Container(
