...
class SubContractMineDetailPage extends StatefulWidget {
  String code;
  ...
  _SubContractMineDetailPageState createState() =>
      _SubContractMineDetailPageState();
}

class _SubContractMineDetailPageState
    extends State<SubContractMineDetailPage> {
