...
/// 生意
class BrandBusinessHomePage extends StatefulWidget {
  @override
  _BrandBusinessHomePageState createState() => new _BrandBusinessHomePageState();
}

class _BrandBusinessHomePageState extends State<BrandBusinessHomePage> {
