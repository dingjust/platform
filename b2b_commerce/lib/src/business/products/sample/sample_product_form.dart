...
class _ApparelProductBrandFormState extends State<SampleProductFormPage> {
  ...
  bool _enabled = false;
  SampleProductModel _product = SampleProductModel();
              ...
              child: GestureDetector(
                ...
                onTap: () async {
                  ...
                  dynamic result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FabricCompositionsField(
  ...
  onPublish() {
    ...
    if (widget.isCreate) {
      showDialog(
          ...
          builder: (_) {
            return RequestDataLoading(
              requestCallBack: SampleProductRepository.create(_product),
      ...
      showDialog(
          ...
          builder: (_) {
            return RequestDataLoading(
              requestCallBack: SampleProductRepository.update(_product),
              outsideDismiss: false,
              loadingText: '保存中。。。',
              entrance: 'apparelProduct',
              keyword: widget.keyword,
