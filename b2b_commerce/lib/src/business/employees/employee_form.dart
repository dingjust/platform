...
class EmployeeFormPage extends StatefulWidget {
  ...
  EmployeeFormPage({Key key, this.name, this.phone, this.pic, this.rule}) : super(key: key);

  @override
  _EmployeeFormPageState createState() => new _EmployeeFormPageState();
}
...
class _EmployeeFormPageState extends State<EmployeeFormPage> {
  ...
  getList() {
    ...
    Iterable<Widget> listTitles = ruleList.map((String item) {
      return new ListTile(
        isThreeLine: true,
        subtitle: new Text(item, style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
