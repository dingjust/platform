...
class _MyContractTemplatePageState extends State<MyContractTemplatePage>
      ...
      child: Scaffold(
        ...
        body: Scaffold(
          ...
          body: TabBarView(
            controller: controller,
            children: statuses
                .map((status) => MyContractTemplateListPage(status: status))
                .toList(),
          ),
        ),
      ),
...
class MyContractTemplateListPage extends StatefulWidget {
  ...
  _MyContractTemplateListPageState createState() =>
      _MyContractTemplateListPageState();
}

class _MyContractTemplateListPageState extends State<MyContractTemplateListPage>
            ...
            SliverToBoxAdapter(
              child: StreamBuilder<TemplateData>(
                ...
                builder: (BuildContext context,
                    AsyncSnapshot<TemplateData> snapshot) {
