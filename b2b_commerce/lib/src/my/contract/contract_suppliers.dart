...
class ContractSuppliersPage extends StatefulWidget {
  ///发布需求的邀请合作商报价
  ...
  const ContractSuppliersPage(
      {Key key, this.quoteInviting = false, this.requirementCode})
      : super(key: key);

  _ContractSuppliersPageState createState() => _ContractSuppliersPageState();
}

class _ContractSuppliersPageState extends State<ContractSuppliersPage> {
  @override
...
class _SuppliersItemState extends State<SuppliersItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.of(context).pop(widget.supplierModel);
      },
    );
  }
