...
class ContractTempSelectPage extends StatefulWidget {
  ...
  String title;
  String type;
  ContractTempSelectPage({this.title, this.contractTempModel,this.type,});
...
class _ContractTempSelectPageState extends State<ContractTempSelectPage>{
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(builder: (_) => ContractTempListState()),
      ],
      child: Consumer<ContractTempListState>(
        builder: (context, contractTempListState,_) {
          ...
          return Scaffold(
            ...
            body: contractTempListState.contractTempModels != null ? ContractTempSingleSelectList(contractTempListState: contractTempListState,model: widget.contractTempModel,) : Center(
