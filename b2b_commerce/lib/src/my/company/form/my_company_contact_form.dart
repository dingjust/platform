...
class MyCompanyContactFormPage extends StatefulWidget {
  B2BUnitModel company;

  bool isEditing;
  bool isDetail;

  MyCompanyContactFormPage({
    this.company,
    this.isEditing = false,
    this.isDetail = false,
  });

  _MyMyCompanyContactFormPageState createState() =>
      _MyMyCompanyContactFormPageState();
}

class _MyMyCompanyContactFormPageState extends State<MyCompanyContactFormPage> {
  String btnText = '编辑';
