      ...
      child: Column(
        children: <Widget>[
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text('附件',style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold
                )),
                SizedBox(width: 20,),
                Text('点击图片查看大图',style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey
                ),)
              ],
...
//              children: widget.company.certificates.map((certificate){
//                return Attachments(
//                  list: Image.network(GlobalConfigs.MEDIA_CONTEXT_PATH+certificate.url,),
//                );
//              }).toList(),
//            ),
