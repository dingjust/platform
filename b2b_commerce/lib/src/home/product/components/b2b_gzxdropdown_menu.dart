...
///gzx_dropdown_menu定制化
class B2BGZXDropDownMenu extends StatefulWidget {
  ...
  @override
  _B2BGZXDropDownMenuState createState() => _B2BGZXDropDownMenuState();
}

class _B2BGZXDropDownMenuState extends State<B2BGZXDropDownMenu>
  ...
  _onController() {
//    print('_B2BGZXDropDownMenuState._onController ${widget.controller.menuIndex}');
...
//    print('_B2BGZXDropDownMenuState.build');
