<template>
  <div class="animated fadeIn">
    <el-table v-if="isHeightComputed" ref="resultTable" stripe :data="page.content" :height="autoHeight">
      <el-table-column label="账单编号" prop="code"  width="150"></el-table-column>
      ...
      <el-table-column label="流水来源" prop="flowSource">
        <template slot-scope="scope">
          {{scope.row.flowSource|enumTranslate('FlowSource')}}
        </template>
      </el-table-column>
      <el-table-column label="流水类型" prop="amountFlowType">
        <template slot-scope="scope">
          {{scope.row.amountFlowType|enumTranslate('AmountFlowType')}}
        </template>
      </el-table-column>
      <el-table-column label="金额" prop="amount"></el-table-column>
      <el-table-column label="剩余总额" prop="totalResidualAmount"></el-table-column>
      <el-table-column label="流水创建时间" prop="creationtime">
        <template slot-scope="scope">
