<template>
  <el-form :inline="true">
    <el-row type="flex" justify="space-between">
      ...
      <el-button-group flex="end">
        <el-button type="primary" @click="onSearchAmountFlows()">交易明细</el-button>
        <!--<el-button type="primary" @click="onSearchAmountFlows()">银行卡</el-button>-->
      </el-button-group>
    </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onSearchAmountFlows() {
        this.$emit('onSearchAmountFlows', 0);
      },
      onAdvancedSearch () {
        this.setKeyword(this.keyword);
        this.$emit('onSearch', 0);
