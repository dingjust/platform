<template>
  <div class="app flex-row login-container">
    <div class="login-body">
          ...
          <el-card class="login-card">
            <div class="tab-container">
              <el-row type="flex" style="height: 100%">
                <div
                  class="tab-btn"
                  :class="activeTabName == 'main' ? 'btn-active' : null"
                  @click="handleTabClick('main')"
                >
                  <span>主账号</span>
                </div>
                <div
                  class="tab-btn"
                  :class="activeTabName == 'employee' ? 'btn-active' : null"
            ...
            <div class="card-main">
              ...
              <div
                id="nc_captcha"
                class="nc-container no-captcha-container"
              ></div>
      ...
      <div class="icp">
        <el-row type="flex" justify="end">
          © 2019-2020 宁波衣加衣供应链管理有限公司 版权所有&nbsp;&nbsp;
           <el-link style="color:white" href="https://beian.miit.gov.cn/#/Integrated/recordQuery" target="blank"> ICP备案号：浙ICP备19000186号-1&nbsp;&nbsp;</el-link>
        </el-row>
      </div>
    </div>
  </div>
