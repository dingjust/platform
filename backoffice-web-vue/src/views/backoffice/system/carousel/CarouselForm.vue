<template>
  <div class="animated fadeIn">
    <el-card class="box-card">
      ...
      <el-form ref="carouselForm" label-position="top" :model="slotData" :rules="rules" :disabled="readOnly">
        <el-row :gutter="20">
          <el-row :gutter="20">
            <el-col :span="12">
      ...
      <el-row :gutter="10">
        <el-col :span="24">
          <el-upload ref="uploadForm"
            ...
            <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，建议像素尺寸（宽*高）750*300，且不超过200k</div>
          </el-upload>
        </el-col>
      </el-row>
    </el-card>
