<template>
  <div class="animated fadeIn">
    <el-card class="box-card">
      ...
      <el-form ref="hotProductsForm" label-position="top" :model="slotData" :rules="rules" :disabled="readOnly">
        <el-row :gutter="20">
          <el-row :gutter="20">
            <el-col :span="12">
...
<script>
  export default {
    name: 'HotProductsForm',
    components: {},
    props: ['slotData', 'readOnly'],
    methods: {
      onSubmit() {
        const hotProductsForm = this.$refs['hotProductsForm'];
        hotProductsForm.validate(valid => {
          if (!valid) {
            return false;
          }
    ...
    data() {
      return {
        ...
        uploadUrl: '/djbackoffice/system/hot-products',
        files: []
      };
    }
  };
