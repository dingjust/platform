<template>
  <div class="animated fadeIn">
    ...
    <el-row :gutter="10" v-show="!readOnly">
      <el-col :span="24">
        <el-select placeholder="请选择颜色" filterable v-model="color">
        ...
        <el-select placeholder="请选择尺码" filterable v-model="size">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async doRefresh() {
        const result = await this.$http.get('/djbackoffice/product/variants/' + this.slotData.code);
        if (result["errors"]) {
