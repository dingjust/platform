  ...
  <div class="animated fadeIn content">
    <el-card>
      ...
      <el-table v-if="isHeightComputed" ref="resultTable" stripe :data="page.content" :height="autoHeight">
        ...
        <el-table-column prop="colorCode" label="色值" class="classColor">
          <template slot-scope="scope">
            <span :style="{backgroundColor:scope.row.colorCode}">{{ scope.row.colorCode }}</span>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      _onSearch(page, size) {
        ...
        axios.get("/djbackoffice/product/color", {
          params: params
        }).then(response => {
      ...
      onUpdate(item) {
        axios.put("/djbackoffice/product/color", item)
          .then(() => {
