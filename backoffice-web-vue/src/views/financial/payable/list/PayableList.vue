<template>
  <div>
    <el-table ref="resultTable" stripe :data="page.content" :height="autoHeight">
      <el-table-column label="外接订单号" prop="productionOrder.code" min-width="110px"/>
      ...
      <el-table-column label="合作商" prop="payable.name" min-width="180px"/>
      <!-- <el-table-column label="创建人" prop="creator.name" /> -->
      <el-table-column label="负责人" prop="productionOrder.sendBy.name" />
