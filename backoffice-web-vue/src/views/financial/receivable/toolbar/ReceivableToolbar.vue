<template>
  <div class="receivable-toolbar-container">
    <el-form :inline="true">
      <el-row type="flex" justify="space-between">
        <el-col :span="24">
          ...
          <el-form-item label="部门/人员">
            ...
            <dept-person-select ref="deptPersonSelect" :dataQuery="dataQuery" width="145"
                    :selectDept="queryFormData.depts" :selectPerson="queryFormData.users"/>
          </el-form-item>
          <el-form-item label="合作商">
            <el-input placeholder="输入合作商名称" v-model="queryFormData.belongToName" style="width: 135px"></el-input>
          </el-form-item>
...
<style scoped>
  ...
  .receivable-toolbar-container >>> .el-form-item {
    margin-bottom: 0px;
  }

  .receivable-toolbar-container >>> .el-date-editor .el-range-separator {
    width: 12%;
  }
</style>