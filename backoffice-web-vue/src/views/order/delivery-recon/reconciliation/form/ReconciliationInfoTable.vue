<template>
  <div>
    ...
    <el-table :data="tableData" border ref="table">
      ...
      <el-table-column prop="waveBand" min-width="120px" v-if="tableCol['waveBand']">
      ...
      <el-table-column label="订单款号" prop="orderItemNo" min-width="120px" v-if="tableCol['orderItemNo']">
        <template slot="header">
      ...
      <el-table-column label="交货时间" prop="deliveryDate" min-width="160px" v-if="tableCol['deliveryDate']">
        <template slot="header">
      ...
      <el-table-column label="合同时间" prop="contractDate" min-width="160px" v-if="tableCol['contractDate']">
        <template slot="header">
      ...
      <el-table-column label="定作方式" prop="customizedMode" min-width="120px" v-if="tableCol['customizedMode']">
        <template slot="header">
      ...
      <el-table-column label="装箱单数" prop="packageQuantity" min-width="120px" v-if="tableCol['packageQuantity']">
        <template slot="header">
      ...
      <el-table-column label="正品入库数" prop="storageQuantity" min-width="120px" v-if="tableCol['storageQuantity']">
        <template slot="header">
      ...
      <el-table-column label="合同单价（不含税）" prop="unitContractPrice" min-width="150px" v-if="tableCol['unitContractPrice']">
        <template slot="header">
      ...
      <el-table-column label="快递费" prop="expressFee" min-width="120px" v-if="tableCol['expressFee']">
        <template slot="header">
      ...
      <el-table-column label="扣款" prop="deductionAmount" min-width="120px" v-if="tableCol['deductionAmount']">
        <template slot="header">
      ...
      <el-table-column label="退货" prop="returnQuantity" min-width="120px" v-if="tableCol['returnQuantity']">
        <template slot="header">
      ...
      <el-table-column label="定金" prop="depositAmount" min-width="120px" v-if="tableCol['depositAmount']">
        <template slot="header">
      ...
      <el-table-column label="备注" prop="remark" min-width="225px" v-if="tableCol['remark']">
        <template slot="header">
          <span>备注<el-button type="text" icon="el-icon-error" class="column-close" @click="onDeleteOri('remark')"/></span>
        </template>
        <template slot-scope="scope" v-if="!scope.row.countRow">
...
export default {
  ...
  methods: {
    ...
    onDeleteOri (attribute) {
      this.$set(this.tableCol, attribute, false);
