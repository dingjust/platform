...
<!--      <contract-select :mockData="mockData" @fileSelectChange="onContractSelectChange"/>-->
      <purchase-contract-frame-select v-if="dialogContractVisible" :page="framePage" @onSearchFrameContract="onSearchFrameContract"
                             @onOrderSelectChange="onOrderSelectChange"
...
<script>
    ...
    import PurchaseContractFrameSelect from './PurchaseContractFrameSelect';
