<template>
  ...
  <div>
    <el-dialog v-if="dialogOrderVisible" :visible.sync="dialogOrderVisible" width="80%" class="purchase-dialog"
      ...
      <contract-supplement-form-com :slotData="slotData"
...
<script>
  ...
  import ContractSupplementFormCom from './ContractSupplementFormCom';
  import ContractSealList from '../../../contract/manage/components/ContractSealList';

  export default {
    name: 'ContractPreviewPdfCom',
    props: ['slotData', 'fileUrl'],
    components: {
      ContractSealList,
      ContractSupplementFormCom
    },
    mounted () {
      this.isLoading = true;
    },
