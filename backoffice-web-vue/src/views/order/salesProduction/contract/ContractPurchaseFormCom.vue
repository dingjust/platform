...
<!--      <contract-select :mockData="mockData" @fileSelectChange="onContractSelectChange"/>-->
      <contract-frame-select-com v-if="dialogContractVisible" :page="framePage" @onSearchFrameContract="onSearchFrameContract"
                             @onOrderSelectChange="onOrderSelectChange"
    ...
    <el-dialog :visible.sync="pdfVisible" :show-close="true" style="width: 100%" :close-on-click-modal="false">
      <contract-preview-pdf-com :fileUrl="fileUrl" :slotData="thisContract"/>
    </el-dialog>
...
<script>
    ...
    import ContractFrameSelectCom from './ContractFrameSelectCom';
    ...
    export default {
      name: 'ContractPurchaseFormCom',
      props: ['slotData', 'formData', 'templateData', 'templateId'],
      components: {
        ContractTypeSelect,
        ContractPreviewPdfCom,
        ContractPreview,
        ContractFrameSelectCom,
        ContractOrderSelect,
        TemplateForm,
