      ...
      <el-col :span="12">
        <el-row type="flex">
          <el-col :span="24">
            <el-row type="flex" align="middle" justify="start" :gutter="10">
              <el-col :span="6">
                <h6 class="attributes-row-label" style="">面料成分<span class="info-title_text-sub">(多选)</span></h6>
              </el-col>
              <el-col :span="18">
                <el-select class="attributes-form-selector" multiple v-model="slotData.attributes.fabricCompositions"
                  placeholder="请选择">
                  <el-option v-for="item in fabricCompositions" :key="item.code" :label="item.name" :value="item.code">
                  </el-option>
                </el-select>
              </el-col>
            </el-row>
      ...
      <el-col :span="12">
        <el-row type="flex">
          <el-col :span="24">
            <el-row type="flex" align="middle" justify="start" :gutter="10">
              <el-col :span="6">
                <h6 class="attributes-row-label" style="">版型</h6>
              </el-col>
              <el-col :span="18">
                <el-select class="attributes-form-selector" v-model="slotData.attributes.editionType" placeholder="请选择">
      ...
      <el-col :span="12">
        <el-row type="flex">
          <el-col :span="24">
            <el-row type="flex" align="middle" justify="start" :gutter="10">
              <el-col :span="6">
                <h6 class="attributes-row-label" style="">袖型</h6>
              </el-col>
              <el-col :span="18">
                <el-select class="attributes-form-selector" v-model="slotData.attributes.sleeveType" placeholder="请选择">
      ...
      <el-col :span="12">
        <el-row type="flex">
          <el-col :span="24">
            <el-row type="flex" align="middle" justify="start" :gutter="10">
              <el-col :span="6">
                <h6 class="attributes-row-label" style="">袖长</h6>
              </el-col>
              <el-col :span="18">
            ...
            <el-row type="flex" align="middle" justify="start" :gutter="10">
              ...
              <el-col :span="18">
                <el-select class="attributes-form-selector" v-model="slotData.attributes.thickness" placeholder="请选择">
                  <el-option v-for="item in productThicknesses" :key="item.code" :label="item.name" :value="item.code">
                  </el-option>
                </el-select>
              </el-col>
            </el-row>
...
<script>
  export default {
    name: 'ApparelProductBasicAttributesForm',
