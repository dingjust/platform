<template>
  <div>
    <el-form ref="form" :model="slotData">
      ...
      <el-row :gutter="10" type="flex" align="center">
        <el-col :span="9" class="product-form-row">
          <el-form-item class="product-form-item" :rules="[
                { required: true, message: '请输入打样费', trigger: 'blur'}]" prop="proofingFee">
      ...
      <el-row>
        <h6 class="info-title_text">大货价格<span class="info-title_text-sub_warning">（卖家承担运费,品牌下单时承担百分之50运费）</span></h6>
      </el-row>
      ...
      <el-row :gutter="20" type="flex" align="center">
        <el-col :span="5" class="product-form-row">
          <el-form-item class="purchase-form-item" :rules="[
                { required: true, message: '请输入产量', trigger: 'blur'}]" prop="basicProduction">
            <el-row type="flex" align="middle">
        ...
        <el-col :span="5" class="product-form-row">
          <el-form-item class="purchase-form-item" :rules="[
                { required: true, message: '请输入价格', trigger: 'blur' ,type: 'number'}]" prop="productionDays">
            <el-row type="flex" align="middle">
              <div style="width:85px">
        ...
        <el-col :span="7" class="product-form-row">
          <el-form-item class="purchase-form-item" :rules="[
                { required: true, message: '请输入生产增量', trigger: 'blur'}]" prop="productionIncrement">
            <el-row type="flex" align="middle">
