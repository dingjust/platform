<template>
  <div class="animated fadeIn">
    <el-table ref="resultTable" stripe :data="page.content" v-if="isHeightComputed" :height="autoHeight+50">
      ...
      <el-table-column label="工厂/客户" min-width="120">
        <template slot-scope="scope">
          <span>{{isBrand()?scope.row.belongTo.name:scope.row.purchaser.name}}</span>
        </template>
      </el-table-column>
