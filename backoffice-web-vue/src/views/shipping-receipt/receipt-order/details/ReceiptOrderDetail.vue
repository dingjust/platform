    ...
    <el-card>
      ...
      <el-row type="flex" justify="start" class="basic-row">
        <el-col :span="3">
          <img width="100px" height="100px" :src="
              formData.product.thumbnail != null &&
              formData.product.thumbnail.length != 0
                ? formData.product.thumbnail.url
                : 'static/img/nopicture.png'
            " />
        </el-col>
        <el-col :span="21">
          <el-row type="flex" style="padding: 10px 0px">
            ...
            <el-col :span="8">
              <h6 class="basic-label">
                发货方：{{
                  formData.shipParty != null ? formData.shipParty.name : ""
                }}
              </h6>
            </el-col>
            <el-col :span="8">
              <h6 class="basic-label">
                收货方：{{
                  formData.receiveParty != null
                    ? formData.receiveParty.name
                    : ""
                }}
              </h6>
            </el-col>
          ...
          <el-row type="flex" style="padding-bottom: 10px">
            ...
            <el-col :span="8">
              <h6 class="basic-label">
                发货负责人：{{ formData.merchandiser.name }}
              </h6>
            </el-col>
            <el-col :span="8">
              <h6 class="basic-label">
                联系方式：{{
                  formData.merchandiser.contactPhone
                    ? formData.merchandiser.contactPhone
                    : ""
                }}
              </h6>
          ...
          <el-row type="flex" style="padding-bottom: 10px">
            <el-col :span="12">
              <h6 class="basic-label">
                收货地址：{{ formData.deliveryAddress.details }}
              </h6>
            </el-col>
          </el-row>
          <el-row type="flex" style="padding-bottom: 10px" v-if="
              !formData.isOfflineConsignment && formData.consignment != null
            ">
            <el-col :span="8">
              <h6 class="basic-label">
                发货方式：{{ formData.consignment.carrierDetails.name }}
              </h6>
            </el-col>
            <el-col :span="8">
              <h6 class="basic-label">
                发货单号：{{ formData.consignment.trackingID }}
              </h6>
            </el-col>
          </el-row>
          <el-row type="flex" style="padding-bottom: 10px" v-else>
            <el-col :span="8">
              <h6 class="basic-label">
                物流方式：{{ formData.offlineConsignorMode }}
              </h6>
            </el-col>
            <!-- <el-col :span="8">
      ...
      <el-row type="flex" justify="start" class="basic-row">
        <el-col :span="8" :offset="2">
          <el-row type="flex">
            <h6>
              发货单：<el-button type="text" @click="onShipDetail">
                {{
  ...
  export default {
    ...
    components: {
      ...
      ShippingOrdersDetail: () =>
        import("../../shipping-order/details/ShippingOrdersDetail"),
    },
    computed: {
      //是收货方
