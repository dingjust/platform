      ...
      <el-row type="flex" justify="space-between">
        <el-col :span="24">
          ...
          <el-form-item label="负责人">
            <el-input placeholder="输入负责人名称" v-model="queryFormData.merchandiserName" style="width: 130px"></el-input>
          </el-form-item>
          <el-form-item label="合作商">
            <el-input placeholder="输入合作商名称" v-model="queryFormData.cooperatorName" style="width: 130px"></el-input>
          </el-form-item>
