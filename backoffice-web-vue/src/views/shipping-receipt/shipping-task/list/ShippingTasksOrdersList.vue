<template>
  <div>
    <el-table ref="resultTable" stripe :data="formData.orders" :height="autoHeight">
      ...
      <el-table-column label="收货数"></el-table-column>
      <el-table-column label="收货时间"></el-table-column>
