  ...
  routes: [{
    ...
    },
    {
      ...
      },
      {
        ...
        name: '生产明细',
        props: true,
        component: () => import(/* webpackChunkName: 'accounts' */ '@/views/order/salesProduction/production-task/details/ProductionEntryDetail')
      },
      {
      ...
      },
      {
        ...
        name: '创建外发订单',
        component: () => import(/* webpackChunkName: 'accounts' */ '@/views/order/salesProduction/outbound-order/form/OutboundOrderForm')
      },
      {
