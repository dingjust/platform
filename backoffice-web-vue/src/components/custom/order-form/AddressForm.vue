  ...
  <div>
    <el-form :inline="true" ref="address" :model="address" label-position="left" :disabled="readOnly">
      <el-row type="flex" align="middle" :gutter="10" justify="space-between">
        <el-col :span="5">
          <el-form-item :rules="[{ required: !readOnly, message: '请选择省', trigger: 'change'}]" :prop="'region'">
        ...
        <el-col :span="5">
          <el-form-item :rules="[{ required: !readOnly, message: '请选择市', trigger: 'change'}]" prop="city">
